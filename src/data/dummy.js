...
export const DUMMY_PROFESSIONALS = [
  ...
  },
  {
    ...
    contactName: 'Lasitha',
    bio: 'No Additional Details.',
    city: 'London',
    postcode: 'SW1',
    website: '',
    phone: '07700000000',
    email: 'lasitha@virtualtours.lk',
    services: [{ service: { id: 'svc-web', name: 'Web Development', slug: 'web-development' } }],
    serviceAreas: [{ city: 'London', postcode: 'SW1', radiusMiles: 50 }],
  },
  {
    id: 'pro-7',
    ...
    website: '',
    services: [{ service: { id: 'svc-web', name: 'Web Development', slug: 'web-development' } }],
    serviceAreas: [{ city: 'Manchester', postcode: 'M2', radiusMiles: 40 }],
  },
  {
    id: 'pro-8',
    companyName: 'Other',
    contactName: 'Other Pro',
    bio: 'No Additional Details.',
    city: 'Birmingham',
    postcode: 'B2',
    website: '',
    services: [{ service: { id: 'svc-web', name: 'Web Development', slug: 'web-development' } }],
    serviceAreas: [{ city: 'Birmingham', postcode: 'B2', radiusMiles: 30 }],
  },
]
...
export const DUMMY_LEADS = [
  ...
  },
  {
    ...
    details: [
      { q: "What's your Website requirement?", a: 'Create A New Website' },
      { q: 'How quickly do you want the website updated or launched?', a: 'Flexible / not sure' },
      { q: "What's your budget?", a: '£500 – £2,000' },
      { q: 'Additional Details.', a: 'Need e-commerce support.' },
    ],
  },
  {
    id: 'lead-3',
    ...
    snippet: 'End of tenancy / As soon as possible / Under £500',
    postcode: 'E1*****',
    interest: 8,
    phoneMasked: '078*********',
    emailMasked: 'S*********@y***',
    ...
    maxRespond: 5,
    details: [
      { q: 'Property type', a: 'Flat' },
      { q: 'Number of bedrooms', a: '2' },
      { q: 'Do you need carpet cleaning?', a: 'Yes' },
    ],
  },
]
